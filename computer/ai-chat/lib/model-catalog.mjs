...
import { DEFAULT_CLAUDE_MODEL, DEFAULT_CODEX_MODEL, DEFAULT_ANTIGRAVITY_MODEL } from "./constants.mjs";
 ...
 * map such an orphan to its family's current default. Known models (by id or
 * cli) pass through untouched.
 */
...
/** Short id of OpenCode's default model (e.g. "glm-5p3"). */
