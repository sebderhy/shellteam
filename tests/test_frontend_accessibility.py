...
def test_dashboard_tabs_use_roving_native_controls() -> None:
    ...
    # 8 = Agents, Terminal, Files, Reports, Browser, Knowledge, Apps, Settings.
    # Reports/Browser/Knowledge ship hidden and are revealed by probe/module —
    # a fresh pure-core box still presents its untouched tab row.
    assert len(tabs) == 8
