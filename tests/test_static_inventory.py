...
APPROVED = {
    ...
    "favicon.svg",
    "feedback.js",
    "github-frame.js",   # the shared GitHub-card mount (wizard + Apps tab)
    "icon-192.png",
    "icon-512.png",
    "icons/figma.svg",
    "icons/github.svg",
    ...
    "icons/slack.svg",
    "tokens.css",
    # Brand faces, self-hosted so no page load reaches a third party. SIL Open
    # Font License 1.1 (redistribution permitted); regenerate with
    # scripts/fetch-brand-fonts.py.
    "vendor/fonts/fonts.css",
    "vendor/fonts/libre-franklin-400-latin-ext.woff2",
    "vendor/fonts/libre-franklin-400-latin.woff2",
    "vendor/fonts/libre-franklin-500-latin-ext.woff2",
    "vendor/fonts/libre-franklin-500-latin.woff2",
    "vendor/fonts/libre-franklin-600-latin-ext.woff2",
    "vendor/fonts/libre-franklin-600-latin.woff2",
    "vendor/fonts/spline-mono-400-latin-ext.woff2",
    "vendor/fonts/spline-mono-400-latin.woff2",
    "vendor/fonts/spline-mono-500-latin-ext.woff2",
    "vendor/fonts/spline-mono-500-latin.woff2",
    "vendor/fonts/zilla-slab-400-italic-latin-ext.woff2",
    "vendor/fonts/zilla-slab-400-italic-latin.woff2",
    "vendor/fonts/zilla-slab-400-latin-ext.woff2",
    "vendor/fonts/zilla-slab-400-latin.woff2",
    "vendor/fonts/zilla-slab-600-latin-ext.woff2",
    "vendor/fonts/zilla-slab-600-latin.woff2",
